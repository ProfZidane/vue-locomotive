                    ...
                    <nav class="navbar navbar-expand-lg navbar-light" id="nav" >
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                          <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="pages/service-it.php">IT</a>
                                  <a class="dropdown-item" href="pages/service-telecom.php">Télécom</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="pages/about.php">Qui sommes-nous ?</a>
                                  <!--<a class="dropdown-item" href="pages/partners.php">Partenaires</a>-->
                                  <a class="dropdown-item" href="pages/join-team.php">Carrières</a>
                                  <a class="dropdown-item" href="pages/partners.php">Partenaires</a>
                          ...
                          <form class="form-inline my-2 my-lg-0">
                            <a class="btn btn-outline-warning my-2 my-sm-0" href="pages/contact.php" style="border-radius: 0;" type="submit" id="cbtn">Contactez-nous</a>
                          </form>
                        </div>
                      </nav>
                </div>
