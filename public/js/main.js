...
var rfid = document.getElementById('nav-home-tab1');
var nfc = document.getElementById('nav-profile-tab1');
var image = document.getElementById('Image-nav');

rfid.addEventListener('click', ()=> {
  image.setAttribute('src','../img/1145.jpg');
});
nfc.addEventListener('click', ()=> {
  image.setAttribute('src','../img/2346.jpg');
});
